...
public:
  ...
  /// exists to compute the aabb from the current rotation and translation with the given world scale half-extents of an
  /// aabb.
  ...
  /// detection that works with colliders or other primitive shapes. The support delta is needed for Swept (@JoshD:
  /// clean up later). Should almost never be overridden in a derived collider type.
