...
public:
  ...
  /// Returns the type that is used to store the given attribute, throws exception if the attribute is not in the vertex
  /// definition.
  VertexElementType::Enum GetElementType(VertexSemantic::Enum semantic);

  /// Returns the number of elements stored for the given attribute, throws exception if the attribute is not in the
  /// vertex definition.
