...
/// <param name="Stereo">Audio will be produced using two channels, one for the left speaker and one for the
/// right.</param> <param name="Quad">Audio will be produced using two left channels and two right channels.</param>
