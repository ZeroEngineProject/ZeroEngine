...
/// <param name="Trapezoid">Uses linear ramps during attack and release times. More efficient than RaisedCosine but not
/// as smooth.</param>
...
public:
  ...
  { /*CopySettings(&other); PLATFORMREFACTOR It is NOT legal to call a pure virtual from a constructor! */
  }
