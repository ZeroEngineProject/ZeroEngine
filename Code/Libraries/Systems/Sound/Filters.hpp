...
/// <param name="TriangleWave">Audio generated by a triangle wave (values go linearly from -1 to 1 and back
/// again).</param> <param name="Noise">White noise produced by getting random values between -1 and 1.</param>
