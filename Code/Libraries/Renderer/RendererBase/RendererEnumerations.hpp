...
/// <param name="Write">Depth values are compared to the depth buffer, if comparison succeeds the new value is written
/// to the buffer.</param>
...
/// <param name="SortEvent">An event is sent on CameraViewport every frame for custom logic to determine the sort
/// value.</param> <param name="BackToFrontView">Uses the distance in the view direction, furthest to nearest.</param>
...
/// <param name="Separate">Stencil values will be tested, frontface/backface triangles will use separate
/// settings.</param>
...
/// <param name="IncrementWrap">Increments the current stencil buffer value. Wraps stencil buffer value to zero when
/// incrementing the maximum value.</param> <param name="Decrement">Decrements the current stencil buffer value. Clamps
/// to 0.</param> <param name="DecrementWrap">Decrements the current stencil buffer value. Wraps stencil buffer value to
/// the maximum value when decrementing a stencil buffer value of zero.</param>
...
/// <param name="LargestMultiple">Viewport is the largest multiple of the set resolution that fits in the
/// window.</param>
