...
/// Returns a variant containing the stored value of the specified any if the any's stored value is a basic native type,
/// else Variant()
Variant ConvertBasicAnyToVariant(const Any& anyValue);
/// Returns an any containing the stored value of the specified variant if the variant's stored value is a basic native
/// type, else Any()
