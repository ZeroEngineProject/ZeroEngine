...
{
public:
  ZilchDocument(FilePathClass, "A helper class for building file paths and extracting information from file paths");
  ...
  ZilchDocument(GetDirectoryPath,
                ...
                "If a directory path is passed in (ending in a separator), this will return the directy back with no "
                "modifications. "
  ...
  ZilchDocument(
      ...
      "First this normalizes the path, then if the operating system is case insensative, it will make the path all "
      "lowercase so that it compares.\n"
      "Example: ('C:\\Sandbox\\Engine\\..\\Content\\.\\Player.png') results in 'c:\\sandbox\\content\\player.png'\n");
  ...
  ZilchDocument(WorkingDirectory,
                ...
                "In general the changing of the working directory is discouraged because it may affect assumptions of "
  ...
  ZilchDocument(UserDocumentsDirectory,
                "User saved data that the user can backup or modify should be placed here (read/write/create "
