...
/// Gizmo for modifying an object's basis. Basically a rotation gizmo with arrows and text that label what each basis
/// means.
...
/// Simple "property" for a rotation basis gizmo. Simply stores a cog and the original value of that cog's property for
/// undo.
