...
/// Returns the required stride of the given type with a base alignment factor (rounds up to nearest multiple of
/// alignment)
...
/// Given a field name (after any extra mangling) and the owning class type, generate the property name used to uniquely
/// identify the field.
