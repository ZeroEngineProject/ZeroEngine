...
public:
  ...
  struct FragmentLookup
  {
    ...
    /// Map of properties (by name) of sampled images. This can turn into any number of samplers, images, and sampled
    /// images.
  ...
  /// Find the reflection data for a uniform given the fragment and property. Returns null if the property can't be
  /// found.
  ...
  void FindSamplerReflectionData(ZilchShaderIRType* fragmentType,
                                 StringParam propertyName,
                                 Array<ShaderResourceReflectionData*>& results);
  /// Find the reflection data for a storage image given the fragment and property. Returns null if the property can't
  /// be found.
  ShaderResourceReflectionData* FindStorageImage(ZilchShaderIRType* fragmentType, StringParam propertyName);
  /// Find the reflection data for a structed storage buffer given the fragment and property. Returns null if the
...
public:
  ...
  /// A debug pass will run on the last pass (before the backend) and typically is used for the validator or
  /// disassembler.
